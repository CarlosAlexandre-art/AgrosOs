...
function EquipeTabs({ active, isEnterprise }: { active: 'membros' | 'agentes'; isEnterprise: boolean }) {
  return (
    <div className="flex items-center gap-1 p-1 bg-slate-100 rounded-xl w-fit">
      ...
      <Link
        href={isEnterprise ? '/dashboard/equipe-ia' : '/dashboard/planos'}
      ...
      >
        ...
        Agentes IA
        {!isEnterprise && (
          <svg className="w-3 h-3 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
        )}
      </Link>
    </div>
  )
...
export default async function EquipePage() {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-w-6xl mx-auto">
      <EquipeTabs active="membros" isEnterprise={isEnterprise} />
