    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900">Operacional</h1>
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5 hidden sm:block">Gerencie todas as atividades da sua fazenda</p>
        </div>
