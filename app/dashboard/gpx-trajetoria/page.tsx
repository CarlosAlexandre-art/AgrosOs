        ...
        <div
          className={[
            ...
            panelOpen
              ...
              : 'hidden',
            'md:flex md:relative md:inset-auto md:bottom-auto md:z-auto md:max-h-none md:rounded-none md:w-48 md:shadow-none',
          ].join(' ')}
          style={{ background: 'rgba(8,12,20,0.97)', borderColor: 'rgba(255,255,255,0.07)' }}
        >
          {/* Mobile close button */}
