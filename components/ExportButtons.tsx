...
export default function ExportButtons({ onExportPDF, onExportExcel }: ExportButtonsProps) {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className="flex items-center gap-2 border border-slate-200 bg-white text-slate-700 font-semibold text-sm px-4 py-2.5 rounded-xl hover:border-slate-300 hover:bg-slate-50 transition-all"
      >
